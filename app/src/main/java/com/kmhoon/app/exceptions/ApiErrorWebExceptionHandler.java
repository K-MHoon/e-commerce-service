...
public class ApiErrorWebExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    public ApiErrorWebExceptionHandler(ApiErrorAttributes errorAttributes, ApplicationContext applicationContext, ServerCodecConfigurer serverCodecConfigurer) {
    ...
    private Mono<ServerResponse> renderErrorResponse(
        ...
        Throwable throwable = (Throwable) request
                ...
                .orElseThrow(
                        () -> new IllegalStateException("ServerWebExchange에서 예외 속성이 누락됨"));
